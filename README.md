...
* [x] Create interface to handle deletion of tasks
* [x] Display task name on single click
...
GIF created with [VRecorder](https://v-recorder.en.uptodown.com/android).
